		...
		<div class="row">
			<div class="large-12 columns">
				...
				<ul class="breadcrumbs">
					...
					<li class="current"><a href="#">Configure UCM</a></li>
				</ul>
			</div>
		</div>
		<div class="row">
			<div class="large-12 large-centered columns">
				<form:form method="post" action="UCMGeneratorSubmission.html"
					...
					<fieldset>
						<legend>Please change the inputs if necessary</legend>
						<div class="row">
						...
						<div class="row">
							...
							<div class="large-4 medium-4 columns">
								<label>Voice Enabled <form:select path="voice_enabled">
						...
						<div class="row">
							<div class="large-4 medium-4 columns">
								<label>Secure Comms Mode<form:input
										path="secure_comms_mode" /></label>
							</div>
							<div class="large-4 medium-4 columns">
								<label>UCP<form:input path="ucp" /></label>
							</div>
							<div class="large-4 medium-4 columns">
								<label>Soft ID <form:input path="soft_id" /></label>
							</div>
						...
						<div class="row">
							<div class="large-4 medium-4 columns">
								<label>Primary AP <form:select
										path="primary_core_access_point_name_id">
										<form:options items="${coreAccessPointForm.coreAccessPoints}"
							...
							<div class="large-4 medium-4 columns end">
								<label>Backup Core AP<form:select
										path="backup_core_access_point_name_id">
										<form:options items="${coreAccessPointForm.coreAccessPoints}"
											var="coreaccesspoint" itemValue="core_access_point_id"
											itemLabel="core_access_point_name"></form:options>
									</form:select></label>
