		...
		<table>
			...
			<tr>
				...
				<td><form:select path="security_group_id" disabled="true">
						<form:options items="${UCMUpdate.securityGroupForm.securityGroups}"
							var="securitygroup" itemValue="security_group_id" itemLabel="security_group"></form:options>
					</form:select></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><form:select path="radio_modulation_type_id" disabled="true">
			...
			<tr>
				<td colspan="2"><input type="submit" value="Back to UCM update" /></td>
			</tr>
		</table>
	</form:form>
</body>
